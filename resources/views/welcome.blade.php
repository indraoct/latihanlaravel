			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-user dropdown-dark">
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
						<img alt="" class="img-circle" src="{{asset("assets/admin/layout3/img/avatar9.jpg")}}">
					...
					<div class="row thumbnails">
						<div class="col-md-3">
							<div class="meet-our-team">
								...
								<img src="{{asset("assets/admin/pages/media/pages/2.jpg")}}" alt="" class="img-responsive"/>
								<div class="team-info">
									<p>
						...
						<div class="col-md-3">
							<div class="meet-our-team">
								...
								<img src="{{asset("assets/admin/pages/media/pages/3.jpg")}}" alt="" class="img-responsive"/>
								<div class="team-info">
									<p>
										 Donec id elit non mi porta gravida at eget metus. Fusce dapibus, justo sit amet risus etiam porta sem...
									</p>
...
<div class="page-footer">
	<div class="container">
		 {{ date("Y") }} &copy; Metronic. All Rights Reserved.
	</div>
</div>
